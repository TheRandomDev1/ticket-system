...
client.on("messageCreate", async (message) => {
    ...
    if(cmd == "delete"){
        message.delete('making room for new channels')
    }
    ...
    if(cmd == "setup") {
        ...
        let TicketEmbed = new Discord.MessageEmbed()
            ...
            .addOptions([ //maximum 25 items
                {
                    label: "Order a server".substr(0, 25), //maximum 25 Letters long
                    value: "order_server".substr(0, 25), //maximum 25 Letters long
                    description: "Select me to order a server!".substr(0, 50), //maximum 50 Letters long
                    emoji: "🛒", //optional
                },
                {
                    label: "Order a bot".substr(0, 25), //maximum 25 Letters long
                    value: "order_bot".substr(0, 25), //maximum 25 Letters long
                    description: "Select me to order a bot!".substr(0, 50), //maximum 50 Letters long
                    emoji: "🤖", //optional
                }
            ])
        ...
        switch(interaction.values[0]){
            case "order_server": {
                let channel = await CreateTicket({
                    OpeningMessage: "Now creating an Server Order Ticket ...",
                    ClosedMessage: `Server Order Ticket Opened in: <#{channelId}>`,
            ...
            case "order_bot": {
                let channel = await CreateTicket({
                    OpeningMessage: "Now creating the Order Bot Ticket ...",
                    ClosedMessage: `Order Bot Ticket Opened in: <#{channelId}>`,
